...
class NetworkClient : NSObject {
    ...
    // configuration object - use for building imageURLs in movie manager
//    var config = NetworkConfig()
    ...
    private func networkURLFromParameters(parameters: [String:AnyObject], withPathExtension: String? = nil) -> NSURL {
